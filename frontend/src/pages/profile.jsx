      ...
      <div className="bg-white border rounded-lg p-6 shadow-sm">
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-500 mt-1">Member since October 2022</p>
      ...
      <div className="bg-white border rounded-lg p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="font-medium">John Andrew Smith</p>
          </div>
          <div>
            <label className="block text-sm text-gray-500 mb-1">Date of Birth</label>
            <p className="font-medium">May 24, 1985</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="font-medium">Sarah Smith (Sister)</p>
            <p className="font-medium">+91 89765 43210</p>
          </div>
        </div>
      </div>
